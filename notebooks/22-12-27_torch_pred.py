...
model = torch.load("/home/yuning/thesis/valid/models/23-1-5{}.pt".format(num_step))
model.eval()
...
plt.figure(0)
clb = Plot_2D_snapshots(pred.cpu().squeeze(),"/home/yuning/thesis/valid/fig/23-1-5/pred{}".format(num_step))
plt.colorbar(clb)

plt.figure(1)
clb = Plot_2D_snapshots(y.cpu().squeeze(),"/home/yuning/thesis/valid/fig/23-1-5/tar{}".format(num_step))
plt.colorbar(clb)

plt.figure(2)
clb = Plot_2D_snapshots(pred.cpu().squeeze()-y.cpu().squeeze(),"/home/yuning/thesis/valid/fig/23-1-5/error{}".format(num_step))
plt.colorbar(clb)
