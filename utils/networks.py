...
# class FCN_Pad_Xaiver_gain(nn.Module):
    ...
    #     self.initial_norm = nn.BatchNorm2d(self.channels,eps=1e-4,momentum=0.99)
    ...
    #     torch.manual_seed(0)
    #     gain = nn.init.calculate_gain("leaky_relu",0.2)
    #     nn.init.xavier_uniform_(self.conv1.weight,gain);nn.init.zeros_(self.conv1.bias)
    #     nn.init.xavier_uniform_(self.Tconv1.weight,gain);nn.init.zeros_(self.Tconv1.bias)

    #     nn.init.xavier_uniform_(self.conv2.weight,gain);nn.init.zeros_(self.conv2.bias)
    #     nn.init.xavier_uniform_(self.Tconv2.weight,gain);nn.init.zeros_(self.Tconv2.bias)

    #     nn.init.xavier_uniform_(self.conv3.weight,gain);nn.init.zeros_(self.conv3.bias)
    #     nn.init.xavier_uniform_(self.Tconv3.weight,gain);nn.init.zeros_(self.Tconv3.bias)

    #     nn.init.xavier_uniform_(self.conv4.weight,gain);nn.init.zeros_(self.conv4.bias)
    #     nn.init.xavier_uniform_(self.Tconv4.weight,gain);nn.init.zeros_(self.Tconv4.bias)

    #     nn.init.xavier_uniform_(self.out.weight,gain);nn.init.zeros_(self.out.bias)
    #     print("All layer has been correctly initialized")
